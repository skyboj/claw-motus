...
- [x] TASK-013: Add 7 hero images to photo gallery and deploy
- [x] TASK-014: Add inner/outer glow to gallery frames for rich depth
- [x] TASK-015: Slow gallery speed 15% and intensify outer frame glow
- [x] TASK-016: Deploy updated live-events video
- [x] TASK-017: Delete old live-events background video from public/dist and server
...
- [x] TASK-025: Move San Francisco background from global grain wrap exclusively to #about section
- [x] TASK-026: Add background image to Quote Hook section
- [x] TASK-027: Add San Francisco background image to the Hero section
- [x] TASK-028: Fix Hero section background image visibility
- [x] TASK-029: Dim the Hero section background image by 70%
- [x] TASK-030: Increase Hero section dimming overlay to 90%
